...
- [Hoist Static I/O to Module Level](#hoist-static-io-to-module-level)
- [Avoid Shared Module State for Request Data](#avoid-shared-module-state-for-request-data)
- [Parallel Data Fetching with Component Composition](#parallel-data-fetching-with-component-composition)
- [Parallel Nested Data Fetching](#parallel-nested-data-fetching)
...
For static assets and config, see [Hoist Static I/O to Module Level](#hoist-static-io-to-module-level).
