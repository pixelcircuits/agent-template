...
- [Do Not Put Effect Events in Dependency Arrays](#do-not-put-effect-events-in-dependency-arrays)
- [Store Event Handlers in Refs](#store-event-handlers-in-refs)
- [Initialize App Once, Not Per Mount](#initialize-app-once-not-per-mount)
- [useEffectEvent for Stable Callback Refs](#useeffectevent-for-stable-callback-refs)
