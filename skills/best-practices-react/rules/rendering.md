...
- [Suppress Expected Hydration Mismatches](#suppress-expected-hydration-mismatches)
- [Use React DOM Resource Hints](#use-react-dom-resource-hints)
- [Use defer or async on Script Tags](#use-defer-or-async-on-script-tags)
