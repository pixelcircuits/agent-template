...
- [Use flatMap to Map and Filter in One Pass](#use-flatmap-to-map-and-filter-in-one-pass)
...
- [Defer Non-Critical Work with requestIdleCallback](#defer-non-critical-work-with-requestidlecallback)
